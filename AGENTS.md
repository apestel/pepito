...
Ce fichier oriente Codex (et les humains) sur l'intention du projet, la stack, les
...
La procédure complète vit dans le skill **`.Codex/skills/release/SKILL.md`** (versionné, d'où le
`!.Codex/skills/` dans `.gitignore`). En résumé : quatre portes — tests verts, changelog
